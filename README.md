...
**1. Model Architecture**
   ...
   - Inception V3 and Inception-Resnet-V2 are widely-used image recognition models that have been trained with ImageNet dataset. Inception V3 and Inception-Resnet-V2 show 0.779 TOP-1 accuracy, 0.937 TOP-5 accuracy and 0.803 TOP-1 accuracy, 0.953 TOP-5 accuracy, respectively. (https://keras.io/api/applications/)  
